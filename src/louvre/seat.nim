...
type Seat* {.importcpp: "Louvre::LSeat", inheritable.} = object of FactoryObject

func gpus(seat: var Seat): CppVector[ptr GPU] {.importcpp: "Louvre::LSeat::gpus".}
func outputs(
  seat: var Seat
): CppVector[ptr Output] {.importcpp: "Louvre::LSeat::outputs".}
func name(seat: var Seat): cstring {.importcpp: "Louvre::LSeat::name".}
proc makeSeat*(
  params: pointer
): Seat {.importcpp: "Louvre::LSeat::LSeat(#)", constructor.}

proc outputPlugged*(
  seat: ptr Seat, output: ptr Output
) {.importcpp: "Louvre::LSeat::outputPlugged".}
...
proc constructSeat*[T](
  typ: typedesc[T], params: pointer
): ptr T {.importcpp: "('1*)(new Louvre::LSeat(@))".}
